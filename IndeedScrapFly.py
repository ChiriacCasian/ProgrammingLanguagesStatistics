...
def update_jobstable(progLang, jobLang, maxpages):
    proglang = "java"
    jobLanguage = "en"
    url="https://nl.indeed.com/jobs?q="+proglang+ "&lang=" + jobLanguage + "&l=netherlands&start=0"
